...
class SystemPromptBuilder @Inject constructor(
    ...
    fun build(): String {
        ...
        return """
            ...
            |
            |AFTER A TOOL CALL:
            |When you receive a tool result, respond with TEXT: summarizing what happened.
            |Speak in first person. Be brief and friendly.
            |Do NOT mention tool names, function names, or IDs.
            |
            |STRICT RULES:
    ...
    private companion object {
        const val TOOL_CALL_FORMAT = """TOOL_CALL: {"name": "tool_name", "arguments": {"param": "value"}}"""
        const val TEXT_FORMAT = "TEXT: your plain text message to the user"
    }
}

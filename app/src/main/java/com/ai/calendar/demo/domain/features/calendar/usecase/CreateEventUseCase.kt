...
) : BaseUseCase<CalendarEvent, Result<Long>>() {
    override suspend fun execute(parameters: CalendarEvent): Result<Long> = useResultWrapper {
        repository.createEvent(parameters)
    }
}
